...
export declare class Carousel<TData> extends React.Component<CarouselProps<TData>, CarouselState> {
    ...
    _getComponentStaticProps(): {
        ref: (c: any) => void;
        contentContainerStyle: (ViewStyle | import("react-native").RegisteredStyle<ViewStyle> | import("react-native").RecursiveArray<ViewStyle | import("react-native").Falsy | import("react-native").RegisteredStyle<ViewStyle>> | {
            paddingTop: number;
        ...
        style: (ViewStyle | import("react-native").RegisteredStyle<ViewStyle> | import("react-native").RecursiveArray<ViewStyle | import("react-native").Falsy | import("react-native").RegisteredStyle<ViewStyle>>)[];
        ...
        CellRendererComponent: React.ComponentType<any> | (({ children, index, style, ...props }: PropsWithChildren<{
            index: number;
            style: StyleProp<ViewStyle>;
        }>) => React.JSX.Element);
