...
type InheritedPropsFromFlatlist<TData> = Pick<FlatListProps<TData>, 'onTouchStart' | 'onTouchEnd' | 'onMomentumScrollEnd' | 'onLayout' | 'keyExtractor' | 'CellRendererComponent' | 'getItemLayout' | 'style'>;
...
export type CarouselProps<TData> = CarouselBaseProps<TData> & (HorizontalCarouselProps<TData> | VerticalCarouselProps<TData>) & InheritedPropsFromFlatlist<TData>;
