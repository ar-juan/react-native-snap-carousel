...
class Carousel extends _react.default.Component {
  ...
  _displayWarnings(props = this.props) {
    ...
    const removedProps = ['activeAnimationType', 'activeAnimationOptions', 'enableMomentum', 'lockScrollTimeoutDuration', 'lockScrollWhileSnapping', 'onBeforeSnapToItem', 'swipeThreshold'];
  ...
  _onMomentumScrollEnd(event) {
    ...
    const scrollOffset = event ? this._getScrollOffset(event) : this._currentScrollOffset;
    const nextActiveItem = this._getActiveItem(scrollOffset);
    const hasSnapped = this._isMultiple(scrollOffset, this.props.vertical ? this.props.itemHeight : this.props.itemWidth);
  ...
  _renderItem({
    ...
    //       } :
    //       {};
    const uniqueKey = this._needsScrollView() ? keyExtractor ? keyExtractor(item, index) : this._getKeyExtractor(item, index) : undefined;
    return /*#__PURE__*/_react.default.createElement(Component, {
      style: [mainDimension, slideStyle, animatedStyle],
      pointerEvents: "box-none",
      key: uniqueKey
    }, this.props.vertical ? this.props.renderItem({
      item,
      index,
      dataIndex
    }, {
  ...
  _getComponentStaticProps() {
    ...
    const contentContainerStyle = [!useExperimentalSnap ? innerMarginStyle : {}, contentContainerCustomStyle || {}];
